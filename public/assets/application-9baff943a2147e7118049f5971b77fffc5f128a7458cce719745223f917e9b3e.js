...
(function() {
  this.passMemberEmail = function() {
    return console.log('came in passemail');
  };

  this.getMemberEmail = function() {
    var customer_email, customer_id, formattedStr, iframeURL, paramStr;
    ...
    this.passMemberEmail;
    return console.log('came after getemail');
  };

  $(document).ready(this.getMemberEmail);
